...
import CruiseHero from "@/components/hero/cruise-hero";
...
export const metadata = {
    title: "Cruise Holidays || Halo Flights LK - Here For You",
    description: "Cruise Holidays || Halo Flights LK",
  };
...
export default dynamic(() => Promise.resolve(cruise_holidays), { ssr: false });
