...
export const metadata = {
    title: "Honeymoon Holidays || Halo Flights LK - Here For You",
    description: "Honeymoon Holidays || Halo Flights LK",
  };

const honeymoon_holidays = () => {
  return (
    <>
      {/* End Page Title */}
...
export default dynamic(() => Promise.resolve(honeymoon_holidays), { ssr: false });
