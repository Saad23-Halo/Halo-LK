...
import Overview from "@/components/holidays/singapore/Overview";
import TopBreadCrumb from "@/components/holidays/singapore/TopBreadCrumb";
import SidebarRight from "@/components/holidays/singapore/SidebarRight";
import SidebarRight2 from "@/components/holidays/singapore/SidebarRight2";
import ReviewProgress from "@/components/holidays/singapore/guest-reviews/ReviewProgress";
import DetailsReview from "@/components/holidays/singapore/guest-reviews/DetailsReview";
import ReplyForm from "@/components/holidays/singapore/ReplyForm";
import ReplyFormReview from "@/components/holidays/singapore/ReplyFormReview";
import Facilities from "@/components/holidays/singapore/Facilities";
...
export const metadata = {
  ...
  description: "Singapore || Halo Holidays",
};
...
export default dynamic(() => Promise.resolve(singapore), {
  ssr: false,
});
